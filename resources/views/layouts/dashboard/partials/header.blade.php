<div class="page-main-header">
    <div class="main-header-right row m-0">
        <div class="main-header-left">
            <div class="logo-wrapper"><a href="#route_index"><img class="img-fluid"
                        src="{{ asset('assets/images/logo/ksl-logo.svg') }}" alt=""></a> 
                        <span style="color:darkred;" class="px-2"><b>Admin Panel</b></span></div>
            <div class="dark-logo-wrapper"><a href="#route_index"><img class="img-fluid"
                        src="{{ asset('assets/images/logo/ksl-logo.svg') }}" alt=""></a></div>
            <div class="toggle-sidebar">
                <i class="status_toggle middle" data-feather="align-center" id="sidebar-toggle" style="color:darkred"></i>
            </div>
        </div>
