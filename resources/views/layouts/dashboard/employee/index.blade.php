                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="collapse-content" id="collapseContent{{ $employee->id }}">
                                                    {!! $employee->employee_about !!}
                                                </div>
                                                <div class="collapse-link pt-2" onclick="toggleCollapse({{ $employee->id }})">
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <div>
                                                        <a href="{{ route('employee.edit', ['id' => $employee->id]) }}" class="btn btn-outline-primary">Edit</a>
                                                    </div>
